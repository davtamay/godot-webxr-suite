...
| **Blaster** | Grab it, then pull the trigger (**activate**) to fire a projectile from the muzzle — the *grab-it-then-use-it* pattern (guns, spray cans, drills). Drop **XRBlaster** inside any grabbable and point a Muzzle node. |
