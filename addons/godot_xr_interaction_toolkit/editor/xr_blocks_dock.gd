...
const BLOCKS := [
	...
	{"name": "Locomotion", "desc": "Teleport arc (thumbstick forward) + snap turn (thumbstick sideways). Built into the rig by default.", "kind": "node", "base": "Node", "path": "res://addons/godot_xr_interaction_toolkit/runtime/xr_locomotion.gd", "icon": "res://addons/godot_xr_interaction_toolkit/icons/xr_locomotion.svg"},
	{"name": "Input Modality", "desc": "Per-hand controller/hands switching + profile-matched controller models. Built into the rig by default.", "kind": "node", "base": "Node", "path": "res://addons/godot_webxr_kit/runtime/xr_input_modality_manager.gd", "icon": "res://addons/godot_webxr_kit/icons/xr_input_modality_manager.svg"},
	{"name": "Gesture Recognizer", "desc": "Hand gestures as data (.tres) - presets included, tune live with show_debug. Per-hand start/end signals.", "kind": "node", "base": "Node", "path": "res://addons/godot_xr_interaction_toolkit/runtime/gestures/xr_gesture_recognizer.gd", "icon": "res://addons/godot_xr_interaction_toolkit/icons/xr_gesture_recognizer.svg"},
	{"name": "Gesture Recorder", "desc": "Hold a pose, get a gesture (.tres, tolerances from your own jitter). Browser saves = that browser only; record via Link/native for real files.", "kind": "node", "base": "Node", "path": "res://addons/godot_xr_interaction_toolkit/runtime/gestures/xr_gesture_recorder.gd", "icon": "res://addons/godot_xr_interaction_toolkit/icons/xr_gesture_recognizer.svg"},
	...
	{"name": "Poke Interactor", "desc": "Fingertip touch input: press panels and drag sliders by touch, push 3D buttons. Built into the rig by default.", "kind": "node", "base": "Node", "path": "res://addons/godot_xr_interaction_toolkit/runtime/xr_poke_interactor.gd", "icon": "res://addons/godot_xr_interaction_toolkit/icons/xr_poke_interactor.svg"},
